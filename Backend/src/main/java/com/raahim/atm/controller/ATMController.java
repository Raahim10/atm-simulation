package com.raahim.atm.controller;

import com.raahim.atm.model.Transaction;
import com.raahim.atm.model.User;
import com.raahim.atm.repository.TransactionRepository;
import com.raahim.atm.repository.UserRepository;
...
public class ATMController {
    ...
    public ResponseEntity<?> login(@RequestBody Map<String, String> loginData) {
        User user = userRepo.findByUsernameAndPin(loginData.get("username"), loginData.get("pin"));
